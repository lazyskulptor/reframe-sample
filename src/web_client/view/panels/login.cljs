(ns web-client.view.panels.login
  (:require
   [reagent.core :as r]
   [re-frame.core :refer [dispatch]]
   [web-client.events.auth :as events]
       ...
       [:div
        ...
        [:a
         {:class
          ...
          :on-click #(dispatch [::events/signin (:username @state) (:password @state)])}
         "Log in"]
        [:hr {:class "my-8"}]
        [:button
         {:class
...
(defmethod l/panels :login-panel []
  [l/centered images (form)])
